        ...
        <Card className="mb-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent>
            <ul className="grid grid-cols-2 gap-4">
              <li className="flex items-center"><Dog className="mr-2 h-5 w-5 text-blue-600" /> Loyal and affectionate</li>
              <li className="flex items-center"><Dog className="mr-2 h-5 w-5 text-blue-600" /> Highly trainable</li>
              <li className="flex items-center"><Dog className="mr-2 h-5 w-5 text-blue-600" /> Various sizes and breeds</li>
              <li className="flex items-center"><Dog className="mr-2 h-5 w-5 text-blue-600" /> Excellent sense of smell</li>
              <li className="flex items-center"><Dog className="mr-2 h-5 w-5 text-blue-600" /> Understand human emotions</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent>
            <ul className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <li className="flex items-center"><Paw className="mr-2 h-5 w-5 text-blue-600" /> Labrador Retriever</li>
              <li className="flex items-center"><Paw className="mr-2 h-5 w-5 text-blue-600" /> German Shepherd</li>
              <li className="flex items-center"><Paw className="mr-2 h-5 w-5 text-blue-600" /> Golden Retriever</li>
              <li className="flex items-center"><Paw className="mr-2 h-5 w-5 text-blue-600" /> French Bulldog</li>
              <li className="flex items-center"><Paw className="mr-2 h-5 w-5 text-blue-600" /> Beagle</li>
            </ul>
          </CardContent>
        </Card>
